            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">Admin Management</p>
                </div>
              </a>
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">Management</span>
            ...
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic2">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.pengaturan.alamat') }}"> Alamat</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.feedback') }}">Feedback Visitor</a></li>
                </ul>
              </div>
            </li>
          </ul>
