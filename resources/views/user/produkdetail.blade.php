...
<div class="bg-light py-3">
    <div class="container">
    <div class="row">
        <div class="col-md-12 mb-0"><a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Coffee beans</strong></div>
    </div>
    </div>
</div>
...
<div class="site-section">
    ...
    <div class="row">
        <div class="col-md-6">
        <img src="{{ asset($produk->image) }}" alt="Image" class="img-fluid">
        </div>
        <div class="col-md-6">
