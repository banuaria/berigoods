                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{-- <button id="pay-button" type="button" class="btn btn-success">Bayar</button> --}}
                                        <button type="button" class="btn btn-success" onclick="payment({{$o->id}})">Bayar</button>
