...
<html lang="en">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="/" class="js-logo-clone">berigoods</a>
              </div>
            </div>
      ...
      <div class="container">
          ...
          <div class="col-md-12 col-lg-12">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                ...
                <li class="phone"><a href="tel://23923929210">+62 8177 929 210</a></li>
                <li class="email">berigoods@gmail.com</li>
              </ul>
            </div>
          </div>
        </div>
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script data-cfasync="false"></script><script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" class="text-primary">Colorlib</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
  ...
  <script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-server-5K6Ay2EVOPkOkQrzpcvVBs8w"></script>
