...
*/
Auth::routes();
Route::post('/order/finish', 'user\OrderController@finish');
...
Route::post('/kontak','FeedbackController@store')->name('feedback.store');
Route::get('/bayar','user\OrderController@generatePayment');
...
Route::group(['middleware' => ['auth','checkRole:admin']],function(){
    ...
    Route::get('/admin/feedback','FeedbackController@index')->name('admin.feedback');
    Route::delete('/admin/feedback/{id}','FeedbackController@destroy')->name('feedback.destroy');
...
Route::group(['middleware' => ['auth','checkRole:customer']],function(){
    ...
    Route::get('/order/payment/{id}', 'user\OrderController@payment');
    // Route::get('/order/finish', 'user\OrderController@finish');
   
    // Route::post('/order/checkout', 'user\OrderController@doCheckout');
